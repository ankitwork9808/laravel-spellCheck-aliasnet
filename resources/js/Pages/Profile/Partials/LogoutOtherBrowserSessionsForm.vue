<template>
    <jet-action-section>
        <template #title>
            {{ $page.props.common.browser_sessions }}
        </template>

        <template #description>
            {{ $page.props.common.manage_and_log_out }}
        </template>

        <template #content>
            <div class="max-w-xl text-sm text-gray-600">
                {{ $page.props.common.if_necessary_you_may_log_out }}
            </div>
            ...
            <div class="flex items-center mt-5">
                <jet-button @click="confirmLogout">
                    {{ $page.props.common.log_out_other_browser_sessions }}
                </jet-button>

                <jet-action-message :on="form.recentlySuccessful" class="ml-3">
                    {{ $page.props.common.done }}
                </jet-action-message>
            </div>
            ...
            <jet-dialog-modal :show="confirmingLogout" @close="closeModal">
                ...
                <template #content>
                    {{ $page.props.common.please_enter_your_password }}
